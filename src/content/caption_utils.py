...
_GENRE_LINES: dict[str, tuple[str, ...]] = {
    "horror": ("horror that actually scared me", "do not play this solo", "genuinely unsettling one"),
    "adventure": ("adventure that hooked me fast", "open world done right", "actually worth exploring"),
    "rpg": ("rpg with real depth", "grind that feels rewarding", "surprisingly deep progression"),
    "fighting": ("combat that actually feels good", "movement is so clean", "pvp that takes skill"),
    "fps": ("gunplay hits different", "valorant but roblox", "sweat lobby in the best way"),
    "simulator": ("sim that respects your time", "weirdly addictive loop", "one more run every time"),
    "obby": ("obby that actually challenged me", "rage bait done right", "harder than it looks"),
    "roleplay": ("roleplay that feels alive", "best rp town ive found", "immersion is unreal"),
    "tycoon": ("tycoon you cant put down", "satisfying build up", "numbers go up perfectly"),
    "puzzle": ("puzzle game that broke my brain", "actually makes you think", "clever level design"),
}
